...
fun NotificationDomain.toDTO(accountId: Long) = NotificationDTO(
    id = id,
    accountId = accountId,
    title = title,
    message = message,
...
fun NotificationDomain.toCache() = NotificationCache(
    id = id,
    title = title,
    message = message,
    payload = payload,
...
fun NotificationCache.toDomain() = NotificationDomain(
    id = id,
    title = title,
    message = message,
    payload = payload,
    createdAt = createdAt.asDate(DateFormats.YYYY_MM_dd_T_HH_mm_ss_SSSSSS)?.datetimeUTC ?: UTCLocalDateTime,
    readAt = createdAt.asDate(DateFormats.YYYY_MM_dd_T_HH_mm_ss_SSSSSS)?.datetimeUTC ?: UTCLocalDateTime
)
