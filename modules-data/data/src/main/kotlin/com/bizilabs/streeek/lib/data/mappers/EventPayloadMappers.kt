...
fun IssueCommentEventDTO.toDomain() = IssueCommentEventDomain(
    action = action,
    issue = issue.toDomain(),
    comment = comment.toDomain()
)

fun IssueCommentEventDomain.toDTO() = IssueCommentEventDTO(
    action = action,
    issue = issue.toDTO(),
    comment = comment.toDTO()
)
...
fun PullRequestReviewEventDTO.toDomain() = PullRequestReviewEventDomain(
    action = action,
    review = review.toDomain(),
    pullRequest = pullRequest.toDomain()
)

fun PullRequestReviewEventDomain.toDTO() = PullRequestReviewEventDTO(
    action = action,
    review = review.toDTO(),
    pullRequest = pullRequest.toDTO()
)
...
fun PullRequestReviewCommentEventDTO.toDomain() = PullRequestReviewCommentEventDomain(
    action = action,
    comment = comment.toDomain(),
    pullRequest = pullRequest.toDomain()
)

fun PullRequestReviewCommentEventDomain.toDTO() = PullRequestReviewCommentEventDTO(
    action = action,
    comment = comment.toDTO(),
    pullRequest = pullRequest.toDTO()
)
...
fun ReleaseEventDTO.toDomain() = ReleaseEventDomain(
    action = action,
    release = release.toDomain()
)

fun ReleaseEventDomain.toDTO() = ReleaseEventDTO(
    action = action,
...
fun SponsorshipEventDTO.toDomain() = SponsorshipEventDomain(
    action = action,
    effectiveDate = effectiveDate.asDate()?.datetimeSystem ?: SystemLocalDateTime
)

fun SponsorshipEventDomain.toDTO() = SponsorshipEventDTO(
    action = action,
