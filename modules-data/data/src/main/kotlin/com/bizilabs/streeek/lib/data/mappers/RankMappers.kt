...
fun RankDetailsDomain.toCache() =
    RankDetailsCache(previous = previous?.toCache(), current = current.toCache())

fun RankDetailsCache.toDomain() =
    RankDetailsDomain(previous = previous?.toDomain(), current = current.toDomain())
