...
fun TeamWithMembersDTO.toDomain() =
...
fun TeamMemberAccountDTO.toDomain() =
...
fun TeamMemberAccountCache.toDomain() =
    TeamMemberAccountDomain(
        avatarUrl = avatarUrl,
        createdAt =
...
fun TeamMemberLevelDTO.toDomain() =
...
fun TeamMemberLevelDomain.toCache() =
    TeamMemberLevelCache(
        id = id,
        name = name,
        number = number,
        maxPoints = maxPoints,
...
fun TeamMemberLevelCache.toDomain() =
    TeamMemberLevelDomain(
        id = id,
        name = name,
        number = number,
